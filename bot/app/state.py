...
class Form(StatesGroup):
    ...
    to_select_ticket_number = State()  # Will be represented in storage as 'Form:to_select_ticket_number'
    to_select_edit_field = State()  # Will be represented in storage as 'Form:to_select_edit_field'
